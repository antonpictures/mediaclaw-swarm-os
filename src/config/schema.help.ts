...
export const FIELD_HELP: Record<string, string> = {
  ...
  newspaper:
    "Newspaper configuration settings for overriding the internal development port or mapping it to a custom domain.",
  "newspaper.port":
    "The port the newspaper application will bind to. (Default: 3000)",
  "newspaper.domain":
    "Optional domain name config for hosting the newspaper externally.",

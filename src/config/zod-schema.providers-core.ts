...
export const TelegramAccountSchemaBase = z
  .object({
    ...
    botToken: SecretInputSchema.optional()
      .describe(
        "To get a token, open Telegram and message @BotFather. Send the /newbot command, follow the quick prompts to name your bot, and paste the provided HTTP API token here.",
      )
      .register(sensitive),

...
export const en: TranslationMap = {
  ...
  tabs: {
    ...
    newspaper: "My MediaClaw",
    chat: "Chat",
    globalSyndicate: "Global Newspaper",
    config: "App Settings",
    communications: "Communications",
    appearance: "Appearance",
    automation: "Automation",
    infrastructure: "Infrastructure",
    aiAgents: "Models & Identity",
    debug: "Debug",
    logs: "Logs",
  },
  subtitles: {
    ...
    cron: "Scheduled and background jobs",
    skills: "Extension code to install, patch, or configure",
    nodes: "Running daemon instances",
    retraining: "Sovereign intelligence alignment and neural updates.",
    newspaper: "Publish and syndicate media",
    chat: "Gateway chat for quick interventions.",
    globalSyndicate: "Decentralized P2P Publishing",
    config: "General options affecting your local node",

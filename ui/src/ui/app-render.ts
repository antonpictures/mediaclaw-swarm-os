...
import "./views/global-syndicate.ts";
import "./views/retraining.ts";
import {
  renderChatControls,
...
const lazyNewspaperList = createLazy(() => import("./views/newspaper-list.ts"));
  ...
  return html`
    ...
    >
          ...
          <div class="sidebar-shell">
              ...
              <div class="sidebar-brand">
                ${
                  navCollapsed
                    ? nothing
                    : html`
                        <img class="sidebar-brand__logo" src="${agentLogoUrl(basePath)}" alt="MediaClaw" />
                        <span class="sidebar-brand__copy">
                          <span class="sidebar-brand__eyebrow">${t("nav.control")}</span>
                          <span class="sidebar-brand__title">MediaClaw</span>
                        </span>
                      `
                }
              </div>
            ...
            <div class="sidebar-shell__footer">
              <div class="sidebar-utility-group">
                ${(() => {
                  const port = (configValue?.newspaper as any)?.port ?? 3000;
                  const customDomain = (configValue?.newspaper as any)?.domain;
                  ...
                  return html`
                    <a
                      ...
                      title="Imperial Daily Newspaper (opens in new tab)"
                    >
                      <span class="nav-item__icon" aria-hidden="true">${icons.fileText}</span>
                      ${
                        !navCollapsed
                          ? html`
                              <span class="nav-item__text">Newspaper</span>
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${
          state.tab === "retraining"
            ? html`<retraining-view></retraining-view>`
            : state.tab === "overview"
              ? renderOverview({
        ...
        ${
          state.tab === "newspaper"
            ? lazyRender(lazyNewspaperList, () => html`<newspaper-list></newspaper-list>`)
            : nothing
        }
        ...
        ${
          state.tab === "globalSyndicate"
            ? html`<global-syndicate-feed></global-syndicate-feed>`
            : nothing
        }

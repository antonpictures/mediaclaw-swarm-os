...
export function loadSettings(): UiSettings {
  ...
  const defaults: UiSettings = {
    ...
    token: loadSessionToken(defaultUrl) || "d793cfa1f1787a88a9169a990c7a9009b3db65e9986c6aaa",
    sessionKey: "main",
  ...
  try {
    ...
    const settings = {
      ...
      token: loadSessionToken(gatewayUrl) || "d793cfa1f1787a88a9169a990c7a9009b3db65e9986c6aaa",
      sessionKey:

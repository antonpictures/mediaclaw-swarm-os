                    ...
                    !activeEntry
                      ...
                      : html`
                          <div class="agent-file-header">
                            ...
                            <div class="agent-file-actions">
                              ...
                              <button
                                ...
                                ?disabled=${params.agentFileSaving || (!isDirty && !activeEntry.missing)}
                                @click=${() => params.onFileSave(activeEntry.name)}
                              >
                                ${params.agentFileSaving ? "Saving…" : activeEntry.missing ? "Create File" : "Save"}
                              </button>
                            </div>
                          </div>
                          ${
                          ...
                          <label class="field agent-file-field" style="margin-top: 12px;">
                            <span>Content</span>
                            <textarea
                              class="agent-file-textarea ${activeEntry.missing ? "is-missing" : ""}"
                              placeholder=${activeEntry.missing ? "Start typing to create this file..." : ""}
                              .value=${draft}
                              @input=${(e: Event) =>
